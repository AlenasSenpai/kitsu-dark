...
"}",	
	...
	"}",
	"",
	".about-stat strong, .about-stat .stat-icon path {",
	"    color: #999999;",
	"    fill: #999999;",
	"}",
	"",
	...
	"}",
	"",
	".navbar.primary-nav #exCollapsingNavbar2 {",
	"    margin-left: 10px;",
	"}",
	"",
	".stream-item--title-block .author-avatar .lazy-image, .stream-item--title-block .author-group-avatar .lazy-image, .stream-item--title-block .author-group-avatar img {",
	"    height: 60px;",
	"    width: 60px;",
	"}",
	"",
    ...
    "}",
    "",
    ".user-menu-drop .dropdown-item:last-child {",
    "    border-bottom: 0px solid #f75239;",
    "}",
	".site-search__input, .site-search__input::placeholder {",
    "    background: #f75239;",
    "    color: #e5e5e5;",
    "}",
    "",
