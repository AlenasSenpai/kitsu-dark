...
(function() {var css = [
	...
	" * Changelog: updated most of the main feed areas for replies and such, so everything is nice and clean *hotfix 1.5.3*",
	"",
	" */",
	"",
	"",
	...
	"}",
	"",
	".sm-comment-count, .stream-item-activity .like-stream-item {",
	"    top: 6px;",
	"    margin-right: 10px;",
	"}",
	"",
